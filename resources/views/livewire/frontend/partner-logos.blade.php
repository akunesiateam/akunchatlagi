<div>
    ...
    @php
        $settings = get_batch_settings([
            'theme.partners_logos_enabled',
            'theme.partners_logo_header',
            'theme.partners_logo_description',
            'theme.partner_logos',
            'theme.partners_logo_footer',
        ]);
    @endphp
    @if ($settings['theme.partners_logos_enabled'])
                ...
                <div class="overflow-hidden whitespace-nowrap relative" data-aos="fade-up" data-aos-duration="1000"
                    ...
                    <div class="flex animate-scroll-logos">
                        @php
                            ...
                            if (count($logos) < $minLogosNeeded) {
                                // Repeat the logos array until we have enough
                                $repetitions = ceil($minLogosNeeded / count($logos));
                                for ($i = 0; $i < $repetitions; $i++) {
                                    $duplicatedLogos = array_merge($duplicatedLogos, $logos);
                                }
                            } else {
                                $duplicatedLogos = $logos;
                            }
