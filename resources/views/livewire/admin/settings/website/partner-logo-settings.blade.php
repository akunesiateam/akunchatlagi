            ...
            <form x-data="{
                ...
                <x-card class="rounded-lg">
                    ...
                    <x-slot:content class="space-y-6 p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6" x-data="{ partners_logos_enabled: @entangle('partners_logos_enabled') }">

                            <div>
                                <x-label :value="t('partners_logos_enabled')" class="mb-2" />

                                <x-toggle id="auto-lead-toggle" name="partners_logos_enabled" :value="$partners_logos_enabled"
                                    wire:model="partners_logos_enabled" />

                            </div>

                            <div>
                                <div class="flex items-center">
                                    <span x-show="partners_logos_enabled" class="text-danger-500 mr-1">*</span>
                                    <x-label for="partners_logo_header" :value="t('partners_logo_header')" />
                                </div>

                                <x-input id="partners_logo_header" type="text" class="mt-1 block w-full"
                                    wire:model="partners_logo_header" />
                                <x-input-error for="partners_logo_header" class="mt-2" />
                            </div>

                            <div>
                                <div class="flex items-center">
                                    <span x-show="partners_logos_enabled" class="text-danger-500 mr-1">*</span>
                                    <x-label for="partners_logo_description" :value="t('partners_logo_description')" />
                                </div>


                                <x-input id="partners_logo_description" type="text" class="mt-1 block w-full"
                                    wire:model="partners_logo_description" />
                                <x-input-error for="partners_logo_description" class="mt-2" />
                            </div>

                            <div>
                                <div class="flex items-center">
                                    <span x-show="partners_logos_enabled" class="text-danger-500 mr-1">*</span>
                                    <x-label for="partners_logo_footer" :value="t('partners_logo_footer')" />
                                </div>

                                <x-input id="partners_logo_footer" type="text" class="mt-1 block w-full"
                                    wire:model="partners_logo_footer" />
                                <x-input-error for="partners_logo_footer" class="mt-2" />
                            </div>
                        </div>
                                            ...
                                            <div class="flex items-center space-x-3">
                                                @if ($item['marked_for_removal'] ?? false)
                                                    <div
                                                        ...
                                                        <svg class="w-4 h-4 text-danger-600" fill="none"
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="text-danger-600 text-sm font-medium">
                                                            #{{ $index + 1 }}
                                                        </p>
                                                    </div>
                                                @else
                                                    <div
                                                        ...
                                                        <span
                                                            class="text-white font-bold text-sm">{{ $index + 1 }}</span>
                                                    </div>
                                                    <div>
                                                        <h3
                                                ...
                                                <div class="relative">
                                                    <label for="image_{{ $index }}"
                                                        ...
                                                        <span class="flex items-center space-x-2">
                                                            <svg class="w-8 h-8 md:w-4 md:h-4 text-primary-500"
                                                    ...
                                                    <!-- Loading state -->
                                                    <div wire:loading
                                                        wire:target="logoItems.{{ $index }}.image"
                                                        class="mt-3">
                                                        <div class="flex items-center space-x-2 text-primary-600">
                                                            ...
                                                            <span
                                                                class="text-sm font-medium">{{ t('uploading') }}...</span>
                                                        </div>
                                                    </div>
                                                    <!-- Frontend dimension error -->
                                                    <template x-if="error">
                                                        <div
                                                            class="mt-3 p-3 bg-danger-50 border border-danger-200 rounded-lg">
                                        ...
                                        @else
                                            ...
                                            <div
                                                ...
                                                <div class="flex items-center space-x-3">
                                                    ...
                                                    <div>
                                                        <p class="font-semibold text-danger-800">Scheduled for Removal
                                                        </p>
